...
require.config({
	...
	paths: {
		...
		subroute: "libs/backbone.subroute/backbone-subroute.min",
		routefilter: "libs/backbone.routefilter/backbone-routefilter.min",
		marionette: "libs/backbone.marionette/backbone.marionette.min",
		localstorage: "libs/backbone.localstorage/backbone.localstorage-1.0.min",
