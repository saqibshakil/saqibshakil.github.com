...
define(["require", "exports", "namespace", "backbone", "marionette", "jquery", "underscore", "knockout", "subroute", "knockback"], function(require, exports) {
    ...
    var ModuleRouter = (function (_super) {
        ...
        ModuleRouter.prototype.beforeRoute = function (any) {
            ...
            TransitionRegion.prototype.delegatedshow = function (view) {
                ...
                if (isDifferentView) {
                    this.promiseClose(view).done(function () {
                        ...
                        _this.addTransitionInit(view, _this);
                        view.render();
